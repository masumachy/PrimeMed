                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 text-center">
                        <div class="all-cart">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                            ...
                                            <td>{{money($total)}}</td>
                                            <td><a href="{{action('User\OrderCategoryController@cart_delete',['id'=>$item->id])}}" class="btn btn-danger btn-sm">delete</a></td>
                                      </tr>
                                      @endforeach
                                    </tbody>
                                  </table>
                            ...
                            <a href="{{action('User\OrderCategoryController@checkout_details')}}" class="btn btn-info">CheckOut</a> 
                        </div>
                    </div>
                    <div class="col-xl-2"></div>
                </div>
