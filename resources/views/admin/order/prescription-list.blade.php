                                ...
                                <div class="col-sm-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-right">
                                                <a href="#" class="btn btn-sm btn-primary">Approved</a> || <a onclick="return confirm('are you sure to delete lab information?')" href="{{action('Admin\OrderController@delete',['id'=>$item->id])}}" class="btn btn-sm btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
