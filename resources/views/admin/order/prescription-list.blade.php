                                ...
                                <div class="col-sm-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-right">
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal{{$item->id}}" data-whatever="@mdo">Approved</button> || <a onclick="return confirm('are you sure to delete lab information?')" href="{{action('Admin\OrderController@delete',['id'=>$item->id])}}" class="btn btn-sm btn-danger">Done</a>
                                            
                                                <div class="modal fade" id="exampleModal{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                                <form method="post" class="" action="{{action('Admin\OrderController@updateprescription')}}">
                                                                    @csrf
                                                                    ...
                                                                    <div class="form-group order-form text-left">
                                                                        <label for="recipient-name" class="col-form-label">Total Price</label><br>
                                                                        <input type="text" name="totalPrice" value="{{$item->totalPrice}}">
                                                                    </div>
